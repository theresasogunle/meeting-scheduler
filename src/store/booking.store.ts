...
export const currentStep = derived(bookingStore, ($bookingStore) => $bookingStore.currentStep);

export const currentMonth = derived(bookingStore, ($bookingStore) => $bookingStore.currentMonth);
...
export const availability = derived(bookingStore, ($bookingStore) => $bookingStore.availability);
